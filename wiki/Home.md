...
| **Beta** | New, works but unproven (OpenDAMOS COM_AXIS, the hub launcher, the flash → verify loop, **ECU Drive Android**, brand-new SocketSpy panels). |
...
| **Beta** | Nouveau, fonctionne mais non éprouvé (OpenDAMOS COM_AXIS, le lanceur hub, la boucle flash → vérification, **ECU Drive Android**, panneaux SocketSpy tout neufs). |
