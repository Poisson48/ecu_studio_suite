...
"$QT_ANDROID/bin/qt-cmake" \
  ...
  -DQT_ANDROID_ABIS="${QT_ANDROID_ABIS:-arm64-v8a;x86_64}" \
  -DQT_ANDROID_COMPILE_SDK_VERSION=35 \
  -DQT_ANDROID_MULTI_ABI_FORWARD_VARS="ECU_BUILD_ECU_STUDIO;ECU_BUILD_ECU_DRIVE;ECU_BUILD_TESTS;ECU_BUILD_SOCKETSPY;ECU_MPPS_SIMULATION;ECU_VERSION_OVERRIDE" \
